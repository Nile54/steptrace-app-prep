...
const routes = new Map([
  ...
  ...['bootstrap', 'preview', 'model', 'storage', 'source-selection', 'schema-v1', 'schema-v2', 'comparison', 'review-ui', 'dependencies', 'dependency-ui', 'dependency-demo'].map(name => [`/src/${name}.js`, [`src/${name}.js`, 'text/javascript; charset=utf-8']]),
]);
...
server.listen(port, '127.0.0.1', () => console.log(`StepTrace Session 4 workspace: http://127.0.0.1:${port}`));
