...
const assets = new Map([['/', 'index.html'], ['/styles.css', 'styles.css'], ...['app', 'bootstrap', 'demo', 'model', 'storage', 'source-selection', 'schema-v1', 'schema-v2', 'comparison', 'review-ui', 'dependencies', 'dependency-ui', 'dependency-demo'].map(name => [`/src/${name}.js`, `src/${name}.js`])]);
