...
7. Respect the active session's authorization. Session 5 permits accessibility, keyboard/focus improvements, one-step/full checklist views, offline loading, and compatible local recovery within the existing workflow. Stop before Session 6 evaluation, remote repository/push/deployment/billing/spending/outreach/AI work. Later user choices can revise tools, architecture, scope, and these instructions.
