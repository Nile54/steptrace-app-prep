...
7. Respect the active session's authorization. Session 4 permits confirmed dependencies, explained review propagation, explicit work-change reports, and compatible local recovery. Stop before Session 5 accessibility/offline expansion, remote repository/push/deployment/billing/spending/outreach/AI work. Later user choices can revise tools, architecture, scope, and these instructions.
