...
7. Respect the active session's authorization. Session 2 permits local source-linked tasks and reliable storage/backup/restore. Do not begin source version comparison (Session 3), dependency propagation (Session 4), or remote repository/push/deployment/billing/spending/outreach/AI work. Later user choices can revise tools, architecture, scope, and these instructions.
