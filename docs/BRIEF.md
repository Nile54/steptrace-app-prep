...
- Current public name: **Origin Scholar**, chosen by the user during the design milestone. Formerly **StepTrace**. The descriptive release slug is `steptrace-app-prep`; it does not establish trademark availability or affiliation with similarly named projects.
