...
| Design milestone — in progress | Origin Scholar landing page, workspace and free branded URL | Real screenshots, responsive/accessible controls, retained data semantics, verified public flow and current STATE |
